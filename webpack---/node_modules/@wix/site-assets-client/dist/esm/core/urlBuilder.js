...
export var UrlBuilder = function(siteModels, isStagingRequest) {
    ...
    var buildSiteModelQueryParams = function(siteModels, moduleName) {
        ...
        var _b = siteModels.sitePagesModel,
            ...
            oneDocEnabled = _b.oneDocEnabled;
        var requiredParams = {
        ...
        return __assign(__assign(__assign(__assign(__assign(__assign({}, requiredParams), (experimentsParam(experiments))), csmCacheKeyParam), siteRevisionConfigKeyParam), moduleCacheVersionParam), (oneDocEnabled && {
            oneDocEnabled: oneDocEnabled
        }));
    };
