...
export const reportFallbackBiEvent = (payload, serializedPayload) => {
    ...
    const keyValue = [
        ['src', 11],
        ['evid', 114700],
        ['sessionId', (_payload$ = payload[0]) == null ? void 0 : _payload$.sessionId],
        ['platform', (_payload$2 = payload[0]) == null ? void 0 : _payload$2.platform],
        ['batchLength', batchLength],
        ['batchSize', batchSize],
        ['batchItems', batchItems],
        ['_', Date.now()] // This is the standard way to implement a cache buster ("_" is ignored by default by the BI backend)
    ];
