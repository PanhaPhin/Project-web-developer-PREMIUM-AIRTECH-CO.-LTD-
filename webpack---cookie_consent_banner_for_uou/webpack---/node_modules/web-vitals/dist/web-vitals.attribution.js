var t, e, n = function() {
    ...
    A = function(t) {
        t.forEach((function(t) {
            t.interactionId && (x = Math.min(x, t.interactionId), k = Math.max(k, t.interactionId), I = k ? (k - x) / 7 + 1 : 0)
        }))
    },
    F = function() {
    ...
    O = 0,
    R = function() {
        return (t ? I : performance.interactionCount || 0) - O
    },
    j = [],
    q = function(t) {
        if (j.forEach((function(e) {
            ...
            if (n || P.length < 10 || t.duration > e.latency) {
                ...
                })), P.length > 10 && P.splice(10).forEach((function(t) {
    ...
    W = function(t, e) {
        e = e || {}, b((function() {
            ...
            var r, i = f("INP"),
                a = function(t) {
                    t.forEach(q);
                    var e, n = (e = Math.min(P.length - 1, Math.floor(R() / 50)), P[e]);
                    n && n.latency !== i.value && (i.value = n.latency, i.entries = n.entries, r())
                },
                o = d("event", a, {
                    durationThreshold: null !== (n = e.durationThreshold) && void 0 !== n ? n : 40
                });
            r = l(t, i, N, e.reportAllChanges), o && ("PerformanceEventTiming" in self && "interactionId" in PerformanceEventTiming.prototype && o.observe({
                type: "first-input",
                buffered: !0
            }), p((function() {
                a(o.takeRecords()), r(!0)
            })), u((function() {
                O = 0, P.length = 0, B.clear(), i = f("INP"), r = l(t, i, N, e.reportAllChanges)
            })))
        }))
    },
    z = [],
    ...
    Q = function() {
        ...
        var t = new Set(V.concat(P.map((function(t) {
...
j.push((function(t) {
    ...
    for (var e, n = t.startTime + t.duration, r = V.length - 1; r >= 0; r--)
        if (e = V[r], Math.abs(n - e) <= 8) {
            var i = U.get(e);
    ...
    n !== e && (V.push(n), U.set(n, {
        startTime: t.startTime,
        processingStart: t.processingStart,
        processingEnd: t.processingEnd,
        entries: [t]
    })), (t.interactionId || "first-input" === t.entryType) && _.set(t, n)
}), (function() {
    J < 0 && (J = H(Q))
}));
var X, Y, Z, $, tt = function(t, e) {
        for (var n, r = [], i = 0; n = z[i]; i++)
    ...
    et = function(t, n) {
        e || (e = d("long-animation-frame", K)), W((function(e) {
            H((function() {
                var n = function(t) {
                    var e = t.entries[0],
                        n = _.get(e),
    ...
    gt = function(t, e) {
        e = e || {}, b((function() {
            var n, r = S(),
                ...
                c = d("first-input", o);
            n = l(t, i, vt, e.reportAllChanges), c && (p(v((function() {
...
export {
    M as CLSThresholds, L as FCPThresholds, vt as FIDThresholds, N as INPThresholds, nt as LCPThresholds, at as TTFBThresholds, w as onCLS, D as onFCP, ht as onFID, et as onINP, it as onLCP, ut as onTTFB
};