...
function patch(id, measures, domNodes, imageInfo, services, envConsts, loadImage, isResponsive, bgEffect) {
    ...
    const allowAnimatedTransform = services.isExperimentOpen ? .('specs.thunderbolt.allowAnimatedImageTransform');
    ...
    if (loadImage) {
        if (imageIsAnimated(imageData.uri, imageData ? .hasAnimation) &&
