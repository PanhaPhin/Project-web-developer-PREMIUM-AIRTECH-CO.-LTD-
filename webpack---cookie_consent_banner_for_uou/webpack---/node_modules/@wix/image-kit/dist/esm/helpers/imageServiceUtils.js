...
/**
 * returns true if image is of WEBP type and transform is allowed or is not WEBP format
 */
function canTransformIfWEBP(uri, hasAnimation, allowWEBPTransform = false, allowAnimatedTransform = false) {
    if (!isWEBP(uri)) {
        return true;
    }
 ...
 */
function isImageTransformApplicable(uri, hasAnimation, allowWEBPTransform, allowAnimatedTransform) {
    return (canTransformIfWEBP(uri, hasAnimation, allowWEBPTransform, allowAnimatedTransform) &&
