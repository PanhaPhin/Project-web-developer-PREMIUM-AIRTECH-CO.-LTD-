...
} from './utils/merge-parent-child-schemas';
export var resolveStructuredData = function(tags, context) {
    ...
    var parentSchemas = sdTags.filter(function(sdTag) {
        return !sdTag.meta.parentSchemaType;
    });
    return __spreadArray(__spreadArray([], nonSDataTags, true), parentSchemas.map(function(parentSchema) {
        var childSchema = sdTags.find(function(tag) {
            return tag.meta.parentSchemaType === parentSchema.meta.schemaType;
        });
