...
export var resolvePagination = function(tags, context) {
    ...
    var _b = context,
        _c = siteIDs.CURRENT_PAGE_NUMBER,
        currentPageNumber = _b[_c],
        _d = siteIDs.TOTAL_PAGE_COUNT,
        totalPageCount = _b[_d],
        _e = siteIDs.QUERY_PARAMS_CURRENT,
        currentQueryParams = _b[_e],
        _f = siteIDs.QUERY_PARAMS_TOTAL,
        totalQueryParams = _b[_f];
    var isFirstPage = Number(currentPageNumber) === 1;
    var paginationComponentsTags = [!isFirstPage ?
