...
var buildStructuredData = function(_a) {
    ...
    var meta = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (schemaType ? {
...
var buildTwitterMetaRefs = function(cardType) {
    return [
        buildTwitterMeta('twitter:card', cardType || TWITTER_CARD_SUPPORTED_TYPES.SUMMARY_LARGE_IMAGE),
