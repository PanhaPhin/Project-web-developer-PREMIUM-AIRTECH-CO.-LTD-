(() => {
    ...
    function g(e, t, n) {
        let o;
        f ? (o = document.createEvent("CustomEvent"), o.initCustomEvent(e, !0, !0, n)) : o = new CustomEvent(e, {
            detail: n
    ...
    function F(e, t) {
        const n = function() {
                let e = "";
                for (let t = 0; t < 16; t++) e += j.charAt(Math.floor(Math.random() * k));
                return e
            }(),
            o = function(e) {
    ...
    function K(e, t, n) {
        const o = e.filter((e => !e.embeddedNodes)),
            r = i(n, u) ? X(o, t) : o,
            c = r.map((e => e.tag));
        O(c), g(p.TAGS_LOADING, window, c), r.forEach((e => {
            var t;
    ...
    function ee(e, t) {
        ...
        if (c.errors && c.errors.length > 0 && n(JSON.stringify(c.errors)), c.config) {
            ...
            (u = c.config.consentPolicy) && "object" == typeof u && (T = [...T, ...N(u)]), s && e && e.init({
                consentPolicy: c.config.consentPolicy
            }), "object" != typeof(d = c.config) || Array.isArray(d) || (w = { ...w,
                ...d
            }, g(p.TAG_MANAGER_CONFIG_SET, window, r(w)))
        }
        var d, u, f, m;
        if (c.tags) {
            f = c.tags, i(null == (m = w) ? void 0 : m.experiments, l) ? f.forEach((e => {
                var t;
