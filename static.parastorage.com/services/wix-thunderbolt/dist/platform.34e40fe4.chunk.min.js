...
(self.webpackJsonp__wix_thunderbolt_app = self.webpackJsonp__wix_thunderbolt_app || []).push([
    [2646, 3169, 5445, 569], {
            ...
            const m = (0, s.Og)([(0, s.KT)(o.wk, n.U), (0, s.KT)(o.YG, n.U), (0, s.KT)(o._K, n.U), p.Ix, l.t7, (0, s.lq)(u.Np), (0, s.lq)(g.De), d.Tf, P.Ht, f.n], ((e, {
                ...
                const P = async (e, t) => e === r.SM ? (async () => {
                    ...
                    f = async (e, t, r = !1) => {
                        if (s && r) {
                            const t = `${a[s]?`./${a[s]}/`:"./"}${s}`;
                            return n.navigate(`${t}?appSectionParams=${JSON.stringify({restrictedPageId:e.pageId,restrictedPagePath:(e.relativeEncodedUrl??"").replace("./","/")})}`)
                        }
                        if (p && "SM" === t) {
                            const e = () => {
        ...
        11682: function(e, t, a) {
            ...
            const {
            ...
            } = window.viewerModel, i = Worker && s.includes("platform"), p = i ? (async () => {
                const e = "platform_create-worker started";
                performance.mark(e);
                const t = o.clientWorkerUrl,
                    a = t.startsWith("http://localhost:") || t.startsWith("https://bo.wix.com/suricate/") || document.baseURI !== location.href ? (e => {
                        const t = new Blob([`importScripts('${e}');`], {
                            type: "application/javascript"
                        });
                        return URL.createObjectURL(t)
                    })(o.clientWorkerUrl) : t.replace(r.fileRepoUrl, `${n}/_partials`),
                    s = new Worker(a),
                    i = Object.keys(o.appsScripts.urls).filter((e => !o.bootstrapData.appsSpecData[e] ? .isModuleFederated)).reduce(((e, t) => (e[t] = o.appsScripts.urls[t], e)), {});
                o.sdksStaticPaths && o.sdksStaticPaths.mainSdks && o.sdksStaticPaths.nonMainSdks && s.postMessage({
                ...
                return performance.mark(p), performance.measure("Create Platform Web Worker", e, p), s
            })() : Promise.resolve()
        }
    }
]);
