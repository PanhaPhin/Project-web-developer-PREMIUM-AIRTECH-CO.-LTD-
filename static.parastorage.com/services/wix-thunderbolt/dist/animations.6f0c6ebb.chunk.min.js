    ...
    [974], {
        ...
        8242: function(t, e, n) {
            ...
            function r(t, e, n) {
                ...
                let u, h;
                return "entry" === i ? (u = r - e, h = Math.min(e, c)) : "contain" === i ? (u = Math.min(s - e, r), h = Math.abs(e - c)) : "exit" === i ? (u = Math.max(r, s - e), h = Math.min(e, c)) : "cover" === i && (u = r - e, h = c + e), u + f * h | 0
            }
            ...
            function h(t, e, n, i, h) {
                ...
                for (; g;) {
                    ...
                    const t = window.getComputedStyle(g),
                        ...
                        o = n ? u(t, i) : void 0,
                        r = f(g, i, n);
                    o && "end" in o || (p += r), E.push({
                        element: g,
                        offset: r,
                        sticky: o
                    }), g = g.offsetParent, g || (w = "fixed" === t.position)
                }
                E.reverse();
            ...
            function v(t) {
                const e = i(t, d),
                    ...
                    o = e.horizontal,
                    r = new WeakMap;
                let s, c, f, u, v, g = l(n, o);
                const p = [],
                    w = {
                        viewportWidth: window.document.documentElement.clientWidth,
                        viewportHeight: window.document.documentElement.clientHeight
                    };
                if (e.scenes = t.scenes.map(((t, i) => (t.index = i, t.viewSource && ("string" == typeof t.duration || t.start ? .name) ? (t = h(t, n, g, o, w), e.observeSourcesResize && p.push(t)) : null == t.end && (t.end = t.start + t.duration), null == t.duration && (t.duration = t.end - t.start), t))), p.length) {
                    if (window.ResizeObserver) {
                        const t = new Map;
                        f = new window.ResizeObserver((function(i) {
                            i.forEach((i => {
                                const r = t.get(i.target);
                                e.scenes[r.index] = h(r, n, g, o, w), p.splice(p.indexOf(r), 1, e.scenes[r.index])
                            }))
                        })), p.forEach((e => {
                    ...
                    e.observeViewportResize && (u = function(t, e) {
                        ...
                        p.length = 0, p.push(...t)
                    }), 100), n === window ? window.addEventListener("resize", u) : window.ResizeObserver && (v = new window.ResizeObserver(u), v.observe(n, {
                        box: "border-box"
                    })))
                }
                return e.observeViewportEntry && window.IntersectionObserver && (c = new window.IntersectionObserver((function(t) {
                    ...
                    destroy: function() {
                        e.scenes.forEach((t => t.destroy ? .())), c && (c.disconnect(), c = null), f && (f.disconnect(), f = null), u && (v ? (v.disconnect(), v = null) : window.removeEventListener("resize", u))
                    }
                }
            }
            const g = {
